function calculateReimbursement(projects) {
    ...
    let sortedDays = Object.keys(days).sort((a, b) => new Date(a) - new Date(b)).map(date => days[date]);
  ...
  console.log('Total reimbursement for project set 1:', calculateReimbursement(projectSet1));
  console.log('Total reimbursement for project set 2:', calculateReimbursement(projectSet2));
